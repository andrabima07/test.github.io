...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <div class="container-fluid text-primary p-3 my-3">
                <h1>Home Page</h1>
                <h3><?php echo "Selamat Datang di Home Page pegawai " .$_SESSION['pengguna']; ?></h3>
                <div>Anda Login sebagai Administrator</div>
            </div>
            <div class="container p-3 my-3 display-6">
                Tekan <mark>"Data Siswa"</mark> untuk mengisi sesuai Kelas
            </div>
        </div>
    </div>
</div>
